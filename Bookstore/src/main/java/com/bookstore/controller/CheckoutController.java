...
public class CheckoutController {
	...
	public String checkout(@RequestParam("id") int cartId,
	...
	public String setShippingAddress(@RequestParam("userShippingId") int userShippingId, Principal principal,
			Model model) {
		User user = userService.findByUsername(principal.getName());
	...
	public String setPaymentMethod(@RequestParam("userPaymentId") int userPaymentId, Principal principal,
			Model model) {
		User user = userService.findByUsername(principal.getName());
